...
// CountBy provides a mock function with given fields: ctx, expr
func (_m *MockProfileRepo) CountBy(ctx context.Context, expr exp.Expression) (int64, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, exp.Expression) int64); ok {
		r0 = rf(ctx, expr)
	} else {
		r0 = ret.Get(0).(int64)
	}
...
func (_c *MockProfileRepo_CountBy_Call) Run(run func(ctx context.Context, expr exp.Expression)) *MockProfileRepo_CountBy_Call {
...
func (_c *MockProfileRepo_CountBy_Call) Return(_a0 int64, _a1 error) *MockProfileRepo_CountBy_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProfileRepo_CountBy_Call) RunAndReturn(run func(context.Context, exp.Expression) (int64, error)) *MockProfileRepo_CountBy_Call {
	_c.Call.Return(run)
	return _c
}
