...
type mockConstructorTestingTNewMockHealthcheckRepo interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockHealthcheckRepo(t mockConstructorTestingTNewMockHealthcheckRepo) *MockHealthcheckRepo {
