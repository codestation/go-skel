...
func (_m *MockProfileRepo) DeleteBy(ctx context.Context, expr Expr) (int64, error) {
	ret := _m.Called(ctx, expr)

	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, Expr) (int64, error)); ok {
		return rf(ctx, expr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Expr) int64); ok {
		r0 = rf(ctx, expr)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, Expr) error); ok {
		r1 = rf(ctx, expr)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockProfileRepo_DeleteBy_Call) Run(run func(ctx context.Context, expr Expr)) *MockProfileRepo_DeleteBy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Expr))
	})
	return _c
}
...
func (_c *MockProfileRepo_DeleteBy_Call) RunAndReturn(run func(context.Context, Expr) (int64, error)) *MockProfileRepo_DeleteBy_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteByExternalId provides a mock function with given fields: ctx, externalId
func (_m *MockProfileRepo) DeleteByExternalId(ctx context.Context, externalId uuid.UUID) error {
...
// MockProfileRepo_DeleteByExternalId_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteByExternalId'
type MockProfileRepo_DeleteByExternalId_Call struct {
	*mock.Call
}
...
func (_e *MockProfileRepo_Expecter) DeleteByExternalId(ctx interface{}, externalId interface{}) *MockProfileRepo_DeleteByExternalId_Call {
	return &MockProfileRepo_DeleteByExternalId_Call{Call: _e.mock.On("DeleteByExternalId", ctx, externalId)}
}

func (_c *MockProfileRepo_DeleteByExternalId_Call) Run(run func(ctx context.Context, externalId uuid.UUID)) *MockProfileRepo_DeleteByExternalId_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockProfileRepo_DeleteByExternalId_Call) Return(_a0 error) *MockProfileRepo_DeleteByExternalId_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockProfileRepo_DeleteByExternalId_Call) RunAndReturn(run func(context.Context, uuid.UUID) error) *MockProfileRepo_DeleteByExternalId_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProfileRepo) GetBy(ctx context.Context, expr Expr) (*model.Profile, error) {
	ret := _m.Called(ctx, expr)

	var r0 *model.Profile
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, Expr) (*model.Profile, error)); ok {
		return rf(ctx, expr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Expr) *model.Profile); ok {
		r0 = rf(ctx, expr)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Profile)
...
func (_c *MockProfileRepo_GetBy_Call) Run(run func(ctx context.Context, expr Expr)) *MockProfileRepo_GetBy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Expr))
	})
	return _c
...
func (_c *MockProfileRepo_GetBy_Call) RunAndReturn(run func(context.Context, Expr) (*model.Profile, error)) *MockProfileRepo_GetBy_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProfileRepo) GetByExternalID(ctx context.Context, externalID uuid.UUID) (*model.Profile, error) {
	ret := _m.Called(ctx, externalID)
...
// MockProfileRepo_GetByExternalID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByExternalID'
type MockProfileRepo_GetByExternalID_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - externalID uuid.UUID
func (_e *MockProfileRepo_Expecter) GetByExternalID(ctx interface{}, externalID interface{}) *MockProfileRepo_GetByExternalID_Call {
	return &MockProfileRepo_GetByExternalID_Call{Call: _e.mock.On("GetByExternalID", ctx, externalID)}
}

func (_c *MockProfileRepo_GetByExternalID_Call) Run(run func(ctx context.Context, externalID uuid.UUID)) *MockProfileRepo_GetByExternalID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID))
	})
	return _c
...
func (_c *MockProfileRepo_GetByExternalID_Call) Return(_a0 *model.Profile, _a1 error) *MockProfileRepo_GetByExternalID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockProfileRepo_GetByExternalID_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*model.Profile, error)) *MockProfileRepo_GetByExternalID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockProfileRepo) ListBy(ctx context.Context, expr Expr, opts ...clause.FilterOption) (*response.ListResponse[*model.Profile], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *response.ListResponse[*model.Profile]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, Expr, ...clause.FilterOption) (*response.ListResponse[*model.Profile], error)); ok {
		return rf(ctx, expr, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Expr, ...clause.FilterOption) *response.ListResponse[*model.Profile]); ok {
		r0 = rf(ctx, expr, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*response.ListResponse[*model.Profile])
	...
	if rf, ok := ret.Get(1).(func(context.Context, Expr, ...clause.FilterOption) error); ok {
		r1 = rf(ctx, expr, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockProfileRepo_ListBy_Call) Run(run func(ctx context.Context, expr Expr, opts ...clause.FilterOption)) *MockProfileRepo_ListBy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(Expr), variadicArgs...)
	})
	return _c
}
...
func (_c *MockProfileRepo_ListBy_Call) RunAndReturn(run func(context.Context, Expr, ...clause.FilterOption) (*response.ListResponse[*model.Profile], error)) *MockProfileRepo_ListBy_Call {
	_c.Call.Return(run)
	return _c
}

// ListByEach provides a mock function with given fields: ctx, expr, fn, opts
func (_m *MockProfileRepo) ListByEach(ctx context.Context, expr Expr, fn func(*model.Profile) error, opts ...clause.FilterOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, Expr, func(*model.Profile) error, ...clause.FilterOption) error); ok {
...
func (_c *MockProfileRepo_ListByEach_Call) Run(run func(ctx context.Context, expr Expr, fn func(*model.Profile) error, opts ...clause.FilterOption)) *MockProfileRepo_ListByEach_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(Expr), args[2].(func(*model.Profile) error), variadicArgs...)
	})
	return _c
}
...
func (_c *MockProfileRepo_ListByEach_Call) RunAndReturn(run func(context.Context, Expr, func(*model.Profile) error, ...clause.FilterOption) error) *MockProfileRepo_ListByEach_Call {
	_c.Call.Return(run)
	return _c
}
